// Example program #1 from chapter 5 of Absolute Beginners guide to C
// File chapter5ex1.c

/* This is a sample program that list three kids and their school supply
...
main()
{
	// Set up the variables as well as defining some of them
